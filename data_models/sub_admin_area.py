...
# TODO: this is almost identical to AdministrativeArea() and Country(). Abstract this and all similar classes.
class SubAdministrativeArea(GeographicArea):
    ...
    def __repr__(self):
        str = f'SubAdministrativeArea(NAME: {self.name},  FSID: {self.fsid}'
